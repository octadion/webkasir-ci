    ...
    <div class="box-header">
        <h3 class="box-title">Filter Data</h3>
            ...
            <div class="box box-widget">
                <div class="box-body">
                    <form action="<?=site_url('report/filter_data')?>" method="get">
                    <table width="100%">
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="form-group input-group">
                                    ...
                                    <input type="date" name="daterange"class="form-control" id="" autofocus value="<?php echo date('Y-m-d');?>">
                            ...
                            <td>
                                <div class="form-group input-group">
                                <input type="date" id="sd" name="daterange" autofocus class="form-control"value="<?=date('Y-m-d');?>">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                            ...
                            <td>
                                <div class="form-group input-group">
                                <input type="text"name="row" id="" autofocus class="form-control">
                                </div>
                            </td>
                        </tr>
                        <tr>
